...
class EnhancedTwoYearDatasetsGenerator:
    ...
    def __init__(self, data_path="."):
        ...
        safe_print(
            f"Enhanced Two-Year Datasets Generator with 100% Real Data Verification"
        )
    ...
    def generate_noaa_benchmark_forecast(
        ...
        humidity_factor = 1 + 0.002 * (
            humidity - 60
        )  # Higher humidity = slight increase
    ...
    def generate_enhanced_daily_data(self, city_name):
        ...
        all_features = {
            ...
            "Holiday_Pollution_Impact": city_row.get(
                "Holiday_Pollution_Impact", "moderate"
            ),
    ...
    def generate_enhanced_datasets(self):
        ...
        for idx, city in enumerate(self.cities_df["City"]):
            try:
                safe_print(
                    f"[{idx+1}/100] Processing {city} with COMPREHENSIVE FEATURES..."
                )
    ...
    def save_enhanced_datasets(self):
        ...
        daily_file = (
            Path("..")
            / "final_dataset"
            / f"ENHANCED_TWO_YEAR_daily_dataset_{timestamp}.json"
        )
        ...
        hourly_file = (
            Path("..")
            / "final_dataset"
            / f"ENHANCED_TWO_YEAR_hourly_dataset_{timestamp}.json"
        )
        ...
        results = {
            ...
            "file_locations": {
                ...
                "analysis_results": str(
                    Path("..")
                    / "final_dataset"
                    / f"ENHANCED_TWO_YEAR_analysis_{timestamp}.json"
                ),
            },
        }
...
def main():
    ...
    try:
        ...
        successful_cities, daily_total, hourly_total = (
            generator.generate_enhanced_datasets()
        )
        ...
        daily_file, hourly_file, analysis_file, results = (
            generator.save_enhanced_datasets()
        )
