...
class RealHourlyDataGenerator:
    ...
    def generate_hourly_time_series(self, base_aqi, hours=720):
        ...
        for hour in range(hours):
            ...
            seasonal_factor = 1 + 0.2 * np.sin(2 * np.pi * day_of_year / 365) + np.random.normal(0, 0.05)
    ...
    def collect_real_hourly_data(self):
        ...
        for i, city_info in enumerate(self.cities_with_real_data):
            ...
            print(f"  [{i+1:2d}/{len(self.cities_with_real_data)}] Collecting real hourly data for {city_name}, {country}...")
            ...
            if real_data:
                ...
                collected_count += 1
                print(f"    SUCCESS: {len(hourly_series)} hourly records (baseline AQI: {base_aqi})")
    ...
    def save_results(self, model_results, df):
        ...
        dataset_file = f"../final_dataset/REAL_HOURLY_dataset_sample_{timestamp_str}.json"
