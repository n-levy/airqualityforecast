...
class CityReplacementFor100PercentReal:
    ...
    def __init__(self):
        ...
        self.backup_cities = {
            ...
            "Africa": [
                ...
                {"name": "Port Elizabeth", "country": "South Africa", "lat": -33.9180, "lon": 25.5701}
            ],
            "Europe": [
    ...
    def find_replacement_cities(self):
        ...
        cities_needing_replacement, current_real_cities = self.get_cities_needing_replacement()
        ...
        for continent, failed_cities in cities_needing_replacement.items():
            ...
            for backup_city in backup_cities:
                ...
                viable_count = sum(1 for t in tested_backups if t['data_availability']['data_quality_score'] > 0)
    ...
    def generate_replacement_report(self, recommended_replacements):
        ...
        for continent, replacements in recommended_replacements.items():
            ...
            for swap in replacements['recommended_swaps']:
                ...
                print(f"  ✓ Replace {remove_city} with {replace_city}, {replace_country} (Score: {score})")
            ...
            replacement_report['summary']['replacement_feasibility'][continent] = {
                ...
                'success_rate': successful_swaps / failed_count if failed_count > 0 else 1.0
            }
        
        replacement_report['summary']['total_replacements'] = total_successful_replacements
        ...
        if total_successful_replacements == 22:
            ...
            print(f"⚠️  WARNING: Only {total_successful_replacements}/22 replacements found")
        
        # Save report
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        report_file = f"../final_dataset/100_percent_real_data_replacement_{timestamp}.json"
