...
$ScriptPath = Join-Path $Stage3Root "scripts\providers\etl_cams.py"
...
$exit = $LASTEXITCODE
Pop-Location
if ($exit -ne 0) { throw "ETL CAMS (Stage 3) failed." }
Write-Host "ETL CAMS (Stage 3) completed successfully."