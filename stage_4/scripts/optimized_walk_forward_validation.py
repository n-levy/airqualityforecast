...
class OptimizedWalkForwardValidator:
    ...
    def load_and_prepare_data(self):
        ...
        if self.sample_rate < 1.0:
            test_data = test_data.sample(frac=self.sample_rate, random_state=42).sort_values(['city', 'datetime'])
    ...
    def generate_report(self, metrics_df):
        ...
        ensemble_metrics = avg_metrics.loc[avg_metrics.index.intersection(ensemble_models)]
